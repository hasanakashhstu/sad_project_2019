...
<div class="content">
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
			  <li><a href="main.php" style="color:SparkleBlue">HOME</a><br>
               	    <?php
...
while($row = mysqli_fetch_array($result) )
			{
				...
				echo "<p style='color:DarkRed'>__________________________________________________________________________________</p>";
			}
